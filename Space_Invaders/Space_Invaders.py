...
class Game():
    ...
    def __init__(self, player, alien_group, player_bullet_group, alien_bullet_group):
        ...
        self.new_round_sound = pygame.mixer.Sound("/Users/sammymylove/Desktop/Pygame/Space_Invaders/new_round.wav")
        self.breach_sound = pygame.mixer.Sound("/Users/sammymylove/Desktop/Pygame/Space_Invaders/breach.wav")
        self.alien_hit_sound = pygame.mixer.Sound("/Users/sammymylove/Desktop/Pygame/Space_Invaders/alien_hit.wav")
        self.player_hit_sound = pygame.mixer.Sound("/Users/sammymylove/Desktop/Pygame/Space_Invaders/player_hit.wav")

        #Set font
        self.font = pygame.font.Font("/Users/sammymylove/Desktop/Pygame/Space_Invaders/Facon.ttf", 32)
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, bullet_group):
        ...
        super().__init__()
        self.image = pygame.image.load("/Users/sammymylove/Desktop/Pygame/Space_Invaders/player_ship.png")
        ...
        self.shoot_sound = pygame.mixer.Sound("/Users/sammymylove/Desktop/Pygame/Space_Invaders/player_fire.wav")
...
class Alien(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, velocity, bullet_group):
        ...
        super().__init__()
        self.image = pygame.image.load("/Users/sammymylove/Desktop/Pygame/Space_Invaders/alien.png")
        self.rect = self.image.get_rect()
        ...
        self.shoot_sound = pygame.mixer.Sound("/Users/sammymylove/Desktop/Pygame/Space_Invaders/alien_fire.wav")
...
class PlayerBullet(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, bullet_group):
        ...
        super().__init__()
        self.image = pygame.image.load("/Users/sammymylove/Desktop/Pygame/Space_Invaders/green_laser.png")
        self.rect = self.image.get_rect()
        self.rect.centerx = x
        self.rect.centery = y
...
class AlienBullet(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, bullet_group):
        """Initialize the bullet"""
        super().__init__()
        self.image = pygame.image.load("/Users/sammymylove/Desktop/Pygame/Space_Invaders/red_laser.png")
        self.rect = self.image.get_rect()
        self.rect.centerx = x
        self.rect.centery = y
